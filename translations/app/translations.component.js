...
var TranslationsComponent = (function () {
    function TranslationsComponent(translationService) {
        this.translationService = translationService;
    }
    TranslationsComponent.prototype.getTranslations = function () {
        var _this = this;
        this.translationService.getTranslations()
            .subscribe(function (translations) { return _this.translations = translations; }, function (error) { return _this.errorMessage = error; });
    };
